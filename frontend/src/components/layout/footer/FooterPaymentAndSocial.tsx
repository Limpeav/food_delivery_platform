...
import { SocialLinkConfig } from '@/types/footer';

export const FooterPaymentAndSocial: React.FC = () => {
  const socialLinks = getAvailableSocialLinks();

  const renderSocialIcon = (iconName: SocialLinkConfig['iconName']) => {
    switch (iconName) {
      case 'facebook':
        return (
      ...
      case 'tiktok':
        return (
          <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.29 0 .58.04.85.12V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.82 4.47v-8.12a8.27 8.27 0 0 0 5.77 2.38V11a4.83 4.83 0 0 1-3.77-4.31z" />
          </svg>
        );
      case 'telegram':
        return (
