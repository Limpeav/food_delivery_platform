              ...
              <div
                ...
                className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-center gap-3 ${
                  paymentMethod === 'ONLINE_PAYMENT'
                    ? 'border-[#E1251B] bg-red-50/40 ring-1 ring-[#E1251B]'
                    : 'border-slate-200 hover:border-slate-300'
                }`}
              >
                <div className="p-2.5 rounded-xl bg-red-100 text-[#E1251B]">
                  <CreditCard className="w-5 h-5" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    <p className="text-xs font-bold text-slate-800">Bakong KHQR</p>
                    <span className="text-[10px] bg-[#E1251B] text-white px-1.5 py-0.5 rounded font-black tracking-wider uppercase">
                      KHQR
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-500">Scan via Bakong, ABA, Wing, ACLEDA</p>
                </div>
              </div>
            </div>
          </div>
